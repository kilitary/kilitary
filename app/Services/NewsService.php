...
class NewsService
{
    ...
    protected $proxy = 'socks5://proxy_user:6RiOUenrRET3wRnI@kilitary.ru:48560';
    ...
    public function genProgCode($item)
    {
        ...
        while($rndDims) {
            ...
            if(XRandom::scaled(0, 2) == 1) {
                $code = XRandom::maybe() ?
                    $serializedSign[XRandom::get(0, $idx)] . $serializedSign[XRandom::get(0, $idx)]
                    :
